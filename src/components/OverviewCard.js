const OverviewCard = (props) => {
  ...
  return (
    <div className="flex flex-row items-center justify-start w-full min-h-[70px] bg-black/5 text-black rounded-xl p-6">
      <div className='flex items-center justify-center h-full min-w-[130px]'>
        <div className="min-h-[4vw] min-w-[4vw] mr-2">
          <svg xmlns="http://www.w3.org/2000/svg" version="1.1" fill="#3b82f6" viewBox="0 6 32 20">
            <title>cloud</title>
