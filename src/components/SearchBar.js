...
const SearchBar = (props) => {
  ...
  return (
    <div className="min-h-[50px] flex rounded py-4 pl-6">
      <form className="h-full w-full flex justify-center items-center" onSubmit={props.onLocationChange}>
        <input className="w-full leading-[100%] bg-black/5 rounded sm:text-lg text-xs text-slate-700 h-full ease-in-out duration-200 placeholder-gray-400 appearance-none outline-none py-2 px-4 font-normal" id="username" type="text" placeholder="Location" />
